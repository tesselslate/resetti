...
type Hooks struct {
	...
	FocusLost   string        `toml:"focus_lost"`   // Command to run when an instance loses focus
	FocusGained string        `toml:"focus_gained"` // Command to run when an instance gains focus
